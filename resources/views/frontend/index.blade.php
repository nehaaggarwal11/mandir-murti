        ...
        <div class="row">
            <div class="carousel-inner">
                ...
                <div class="carousel-item @if ($loop->first) active @endif">
                    <img src="{{asset('/public'.$item->logo)}}"
                        class="d-block w-100">
                </div>
                @endforeach
            </div>
            <ol class="carousel-indicators">
                @foreach ($slider_main as $item)
                <li data-target="#home-slider" data-slide-to=" @if($loop->last)
                    echo '1';
                @else
                echo '0';
                @endif" class="active"><img
                    src="{{asset('/public'.$item->logo)}}" class="d-block w-100">
                </li> 
                @endforeach
