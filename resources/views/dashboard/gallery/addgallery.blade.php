        ...
        <div class="card">
          <div class="card-header"><h4>Home Slider</h4></div>
            <div class="card-body">
              ...
              <form action="{{url('gallerysave')}}" method="post"enctype="multipart/form-data">
                @csrf
                <div class="col-md-6">
                  ...
                  {{-- <input type="checkbox" name="{{$cat->category_name}}" id="{{$cat->s_no}}" value="{{$cat->s_no}}">
                  <label for="{{$cat->s_no}}">{{$cat->category_name}}</label><br>  --}}
