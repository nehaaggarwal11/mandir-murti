...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="{{asset('assets/frontend/imgs/logo/mandir-logo-brown3.png')}}" width="60" height="auto" alt=" Logo">
            <img class="c-sidebar-brand-minimized" src="{{asset('assets/frontend/imgs/logo/mandir-logo-brown3.png')}}" width="50" height="auto" alt="Logo">
        </div>
                ...
                @if($menuel['slug'] === 'link')
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link" href="{{ url($menuel['href']) }}">
                         <i class="{{ $menuel['icon']??'cil-pencil' }} c-sidebar-nav-icon"></i>
                        {{ $menuel['name'] }}
                        </a>
                    </li>
